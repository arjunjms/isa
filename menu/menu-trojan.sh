...
BURIQ () {                                           curl -sS  https://raw.githubusercontent.com/arjunjms/izin/main/ipvps > /root/tmp
...
Name=$(curl -sS curl -sS  https://raw.githubusercontent.com/arjunjms/izin/main/ipvps | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS curl -sS  https://raw.githubusercontent.com/arjunjms/izin/main/ipvps | awk '{print $4}' | grep $MYIP)
if [ "$MYIP" = "$IZIN" ]; then
Bloman
else
