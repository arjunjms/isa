...
sleep 1
wget -q -O xraymode.sh https://raw.githubusercontent.com/arjunjms/isa/momok/menu/xraymode.sh && chmod +x xraymode.sh && ./xraymode.sh
sleep 1 
wget -q -O /etc/xray/config.json "https://raw.githubusercontent.com/arjunjms/isa/momok/configuration/config.json"
chmod +x /etc/xray/config.json
sleep 1 
rm -f /etc/nginx/conf.d/xray.conf
wget -q -O /etc/nginx/conf.d/xray.conf "https://raw.githubusercontent.com/arjunjms/isa/momok/configuration/xray.conf"
...
#LIMIT QUOTA
wget -q -O /usr/local/sbin/quota "https://raw.githubusercontent.com/arjunjms/isa/momok/limit/quota.sh"
