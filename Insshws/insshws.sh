...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/arjunjms/isa/momok/Insshws/dropbear-ws.py.txt
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/arjunjms/isa/momok/Insshws/ws-stunnel.txt
...
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/arjunjms/isa/momok/Insshws/service-wsdropbear.txt && chmod +x /etc/systemd/system/ws-dropbear.service

#System SSL/TLS Websocket-SSH Python
wget -O /etc/systemd/system/ws-stunnel.service https://raw.githubusercontent.com/arjunjms/isa/momok/Insshws/ws-stunnel.service.txt && chmod +x /etc/systemd/system/ws-stunnel.service
