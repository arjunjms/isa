...
wget -O /usr/bin/addl2tp https://raw.githubusercontent.com/arjunjms/isa/momok/ipsec/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://raw.githubusercontent.com/arjunjms/isa/momok/ipsec/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://raw.githubusercontent.com/arjunjms/isa/momok/ipsec/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://raw.githubusercontent.com/arjunjms/isa/momok/ipsec/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://raw.githubusercontent.com/arjunjms/isa/momok/ipsec/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://raw.githubusercontent.com/arjunjms/isa/momok/ipsec/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
wget -O /var/lib/crot/data-user-l2tp "https://raw.githubusercontent.com/arjunjms/isa/momok/ipsec/l2tp-user.sh"
wget -O /var/lib/crot/data-user-pptp "https://raw.githubusercontent.com/arjunjms/isa/momok/ipsec/pptp-user"
